        ...
        const user = users.dataValues;   
         ...
         .then((result) => {
          res.redirect("/login");
            ...
            to: user.correo,
            subject: `restabler contraseña de ${user.usuario}`,
            html: "<strong> Su nueva contraseña </strong> <br><br> <p> Su nueva contraseña es: <strong> " +newpass+ " </strong>. Gracias por ser parte de Social Network</p>"
            },
              (err3) => {
                  console.log(err3);
              });
